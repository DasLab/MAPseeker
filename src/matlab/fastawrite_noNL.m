function fastawrite_noNL(filename,header,seq)
...
%   Clarence Cheng, 2013: Change sequence column # limit from 70 to 500.
...
try
    ...
    for i=1:numSequences
        ...
        maxcols = 500; % NCBI uses 70 columns for their FASTA files
