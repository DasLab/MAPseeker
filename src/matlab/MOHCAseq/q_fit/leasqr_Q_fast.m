function [f, g, Qpred ] = leasqr_Q_fast( params, index_into_params, left_right_idx, epsilon_profile, Q, gamma, lambda, seqpos, CALC_HESSIAN );
% [f, g, Qpred ] = leasqr_Q( params, index_into_params, left_right_idx, epsilon_profile, Q, gamma, lambda, seqpos );
% 
% This version does NOT calculate a Hessian.
%
% Inputs:
